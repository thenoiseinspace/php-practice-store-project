...
if(isset($_POST['insert_brand'])){
    ...
    // note--those are backticks around brands, not single quotes
    //this first one checks to make sure the brand that the user is trying to add isnt already in the database
